...
class GoldcoinLogModel {
    ...
    // messenger;
    static $_type_game_share_messenger = 15;
...
//            self::$_type_ad_play_game_end=>'看视频的奖励-玩游戏结束',
            ...
            self::$_type_ad_24_sign => '签到后开宝箱获得奖励',
            ...
            self::$_type_goldcoin_exchange_lucky_jetton => 'Lucky通过筹码方式兑换平台内金币',
            self::$_type_goldcoin_exchange_lucky_balance => 'Lucky通过奖金方式兑换平台内金币',
    ...
    static function getTypeTitle(){
        return array(
            ...
            self::$_type_goldcoin_exchange_lucky_jetton => 'Lucky筹码兑换',
            self::$_type_goldcoin_exchange_lucky_balance => 'Lucky奖金兑换',
        );
    }
