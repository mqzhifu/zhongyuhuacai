<?php
class ExchangeBindQueueCtrl extends BaseCtrl
{
    function index()
    {
        ...
        $this->display("check/exchange_bind_queue_list.html");
    }
    ...
    function getList()
    {
        ...
        $cnt = ExchangeBindQueueModel::db()->getCount($where);
        ...
        if ($iTotalRecords){
            ...
            $data = ExchangeBindQueueModel::db()->getAll($where . $order. " limit $iDisplayStart,$iDisplayLength ");
//            $roles = RolesModel::db()->getAll();
//            $roleNames = [];
