...
class ApiCtrl extends BaseCtrl{
    ...
    function show($module,$func = ""){
        if($func && $func= 'game'){
            include_once CONFIG_DIR ."game/api.php";
            include_once CONFIG_DIR . DS . "game/main.php";
            $domain = "http://isgame-test.heyshell.com/";

        }else{
            include_once CONFIG_DIR . DS .IS_NAME. "/main.php";
