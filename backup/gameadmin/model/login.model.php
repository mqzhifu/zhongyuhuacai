...
class LoginModel {
    ...
    static $_status_gaming = 3;

    static $_close_status_not = 0;
    static $_close_status_normal = 1;
    static $_close_status_error = 2;
    static $_close_status_shut = 3;
    ...
    static function getStatusDesc() {
        return [
            ...
            self::$_status_matching => '匹配中',
            self::$_status_gaming => '游戏中',
        ];
    }

    static function getCloseStatusDesc() {
        return [
            self::$_close_status_not => '未关闭',
            self::$_close_status_normal => '正常关闭',
            self::$_close_status_error => '容错关闭',
            self::$_close_status_shut => '进程结束关闭',
        ];
    }
