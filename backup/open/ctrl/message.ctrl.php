...
class MessageCtrl extends BaseCtrl
{

    public function index()
    {
        $this->checkGame();
        $this->addCss("assets/open/css/message.css");
        $this->display("message.html", "new", "isLogin");
    }
    ...
    public function detail()
    {
        ...
        // 静态文件
        $this->addCss("assets/open/css/messageDetails.css");
        ...
        $this->display("messageDetails.html", "new", "isLogin");
    }
    ...
    public function getMsgList(){
        $gameId = _g('gameid');
        $msgList = GameMessageRuleModel::GetAll($gameId);
        ...
        $this->outputJson(200, "succ", $msgList);
    }
