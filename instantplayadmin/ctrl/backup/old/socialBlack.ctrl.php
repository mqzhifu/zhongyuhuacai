...
class SocialBlackCtrl extends BaseCtrl{
    function index(){
...
//        $this->assign("screenDesc",GamesModel::getScreenDesc());
        ...
        $this->display("social/black_list.html");
    }
    ...
    function getData(){
        ...
        $cnt = FansBlackModel::db()->getCount($where);
...
//            var_dump($where);exit;
            $data = FansBlackModel::db()->getAll($where . $order);
