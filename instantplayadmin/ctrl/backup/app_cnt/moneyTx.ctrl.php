 ...
 * 
 */
class MoneyTxCtrl extends BaseCtrl
{
	...
	function index()
	{
		...
		$this->display("app_cnt/moneyTx/money.html");
	}
	...
	function detail()
	{
		...
		$this->display('app_cnt/moneyTx/audit.html');
	}
        ...
        if ($iTotalRecords){
            ...
            foreach ($orders as $od) {
    			$row = array(
                    ...
                    '<a href="/app_cnt/no/moneyTx/detail/id='.$od['id'].'" class="btn btn-icon-only blue"><i class="fa fa-edit"></i></a>',
                );
                $records["data"][] = $row;
        	}
