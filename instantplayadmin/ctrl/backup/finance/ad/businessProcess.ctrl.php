 ...
 * @Last Modified time: 2019-05-31 17:25:31
 */
...
class BusinessProcessCtrl extends BaseCtrl
{
	...
	function index()
	{
		...
		$this->display("/finance/ad/business_process/index.html");
	}
	...
	function settlement()
	{
		...
		$this->display("/finance/ad/business_process/settlement.html");
	}
	...
	function payApply()
	{
		...
		$this->display("/finance/ad/business_process/pay_apply.html");
	}
        ...
        if ($iTotalRecords){
            ...
            foreach($data as $k=>$v){
                ...
                $row = array(
                    ...
                    $billStatus[$v['status']],
                    '<a href="/finance/ad/businessProcess/settlement/id='.$v['id'].'" class="btn btn-icon-only yellow " title="收入结算设置"><i class="fa fa-cogs"></i> </a>
                    <a href="/finance/ad/businessProcess/printBill/id='.$v['id'].'" class="btn btn-icon-only green " target="_blank" title="下载对账单"><i class="fa fa-plus"></i> </a>
                    <a href="" class="btn btn-icon-only blue " title="推送对账单"><i class="fa fa-bullhorn"></i> </a>
                    <a href="/finance/ad/businessProcess/payApply/id='.$v['id'].'" class="btn btn-icon-only red " title="申请付款"><i class="fa fa-edit"></i> </a>
                    ',
                );
