 ...
 * @Last Modified time: 2019-05-31 17:27:11
 */
...
class FinanceProcessCtrl extends BaseCtrl
{
	...
	function index()
	{
		...
		$this->display("/finance/ad/finance_process/index.html");
	}
	...
	function checkBill()
	{
		...
		$this->display("/finance/ad/finance_process/check_bill.html");
	}
        ...
        if ($iTotalRecords){
            ...
            foreach($data as $k=>$v){
                ...
                $row = array(
                    ...
                    $financeStatus,
                    $payStatus,
                    '<a href="/finance/ad/financeProcess/checkBill/id='.$v['id'].'" class="btn btn-xs default blue" data-id="'.$v['id'].'"><i class="fa fa-file-text"></i> 票据</a>',
                );
