<?php
/**
 * Class GamesScoreMoreModel
 */
class GamesScoreMoreModel {
	static $_table = 'games_score_';
	static $_pk = 'id';
     ...
     * @return mixed
     */
    static function getAll($where, $num_suffix){
        return self::db()->getAll($where, self::getTable($num_suffix));
    }
     ...
     * @return int|mixed
     */
    static function getCount($where, $num_suffix){
        return self::db()->getCount($where, self::getTable($num_suffix));
    }
